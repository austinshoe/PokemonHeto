...
static const u16 sPlayerAvatarGfxIds[][2] =
{
    ...
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_ROCKY_NORMAL,     OBJ_EVENT_GFX_MAI_NORMAL},
    ...
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_ROCKY_SURFING,    OBJ_EVENT_GFX_MAI_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_ROCKY_UNDERWATER, OBJ_EVENT_GFX_MAI_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_ROCKY_FIELD_MOVE, OBJ_EVENT_GFX_MAI_FIELD_MOVE},
