...
const struct Tileset gTileset_fall2 =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_fall2,
    .palettes = gTilesetPalettes_fall2,
    .metatiles = gMetatiles_fall2,
    .metatileAttributes = gMetatileAttributes_fall2,
    .callback = NULL,
};

const struct Tileset gTileset_TallForest =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_TallForest,
    .palettes = gTilesetPalettes_TallForest,
    .metatiles = gMetatiles_TallForest,
    .metatileAttributes = gMetatileAttributes_TallForest,
    .callback = NULL,
};
...
const struct Tileset gTileset_volcano1 =
{
    ...
    .callback = InitTilesetAnim_Volcano,
};
...
const struct Tileset gTileset_EverbloomGym =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_EverbloomGym,
    .palettes = gTilesetPalettes_EverbloomGym,
    .metatiles = gMetatiles_EverbloomGym,
...
const struct Tileset gTileset_Cacti =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_Cacti,
    .palettes = gTilesetPalettes_Cacti,
    .metatiles = gMetatiles_Cacti,
    .metatileAttributes = gMetatileAttributes_Cacti,
    .callback = NULL,
};

const struct Tileset gTileset_cacti2 =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_cacti2,
    .palettes = gTilesetPalettes_cacti2,
    .metatiles = gMetatiles_cacti2,
...
const struct Tileset gTileset_ruinveil2 =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_ruinveil2,
    .palettes = gTilesetPalettes_ruinveil2,
    .metatiles = gMetatiles_ruinveil2,
