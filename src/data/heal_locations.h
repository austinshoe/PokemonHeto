static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_PEARL_TOWN - 1] = {MAP_GROUP(PEARL_TOWN), MAP_NUM(PEARL_TOWN), 12, 26},
    [HEAL_LOCATION_WHISPERING_GROVE - 1] = {MAP_GROUP(WHISPERING_GROVE), MAP_NUM(WHISPERING_GROVE), 20, 20},
};
