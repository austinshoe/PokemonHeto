static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_WHISPERING_GROVE - 1] = {MAP_GROUP(WHISPERING_GROVE), MAP_NUM(WHISPERING_GROVE), 21, 20},
    [HEAL_LOCATION_LUMINA_TOWN - 1] = {MAP_GROUP(LUMINA_TOWN), MAP_NUM(LUMINA_TOWN), 32, 9},
};
