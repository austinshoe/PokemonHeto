static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_PEARL_TOWN - 1] = {MAP_GROUP(PEARL_TOWN), MAP_NUM(PEARL_TOWN), 14, 27},
    [HEAL_LOCATION_LUMINA_TOWN - 1] = {MAP_GROUP(LUMINA_TOWN), MAP_NUM(LUMINA_TOWN), 32, 11},
    [HEAL_LOCATION_EVERBLOOM_CITY - 1] = {MAP_GROUP(EVERBLOOM_CITY), MAP_NUM(EVERBLOOM_CITY), 19, 34},
    [HEAL_LOCATION_KASAAN - 1] = {MAP_GROUP(KASAAN), MAP_NUM(KASAAN), 31, 27},
    [HEAL_LOCATION_NEW_MAP4 - 1] = {MAP_GROUP(NEW_MAP4), MAP_NUM(NEW_MAP4), 22, 21},
    [HEAL_LOCATION_NEW_MAP8 - 1] = {MAP_GROUP(NEW_MAP8), MAP_NUM(NEW_MAP8), 14, 38},
    ...
    [HEAL_LOCATION_MT_EMBERFALL_CRATER - 1] = {MAP_GROUP(MT_EMBERFALL_CRATER), MAP_NUM(MT_EMBERFALL_CRATER), 17, 10},
    [HEAL_LOCATION_RUINVEIL_CITY - 1] = {MAP_GROUP(RUINVEIL_CITY), MAP_NUM(RUINVEIL_CITY), 57, 20},
    [HEAL_LOCATION_LUMINARA_TOWN - 1] = {MAP_GROUP(LUMINARA_TOWN), MAP_NUM(LUMINARA_TOWN), 26, 32},
    [HEAL_LOCATION_SILVERSTONE_CITY - 1] = {MAP_GROUP(SILVERSTONE_CITY), MAP_NUM(SILVERSTONE_CITY), 11, 37},
    [HEAL_LOCATION_POKEMON_LEAGUE - 1] = {MAP_GROUP(POKEMON_LEAGUE), MAP_NUM(POKEMON_LEAGUE), 20, 13},
    [HEAL_LOCATION_FOUROF_SWORDS - 1] = {MAP_GROUP(FOUROF_SWORDS), MAP_NUM(FOUROF_SWORDS), 12, 48},
    [HEAL_LOCATION_HALLOWSPARK_LENA - 1] = {MAP_GROUP(HALLOW_SPARK_CITY), MAP_NUM(HALLOW_SPARK_CITY), 34, 10},
    [HEAL_LOCATION_RUINVEIL_CITY_KANAE - 1] = {MAP_GROUP(RUINVEIL_CITY), MAP_NUM(RUINVEIL_CITY), 41, 35},
    [HEAL_LOCATION_KUROMISA_RUINS_2 - 1] = {MAP_GROUP(KUROMISA_RUINS2), MAP_NUM(KUROMISA_RUINS2), 10, 9},
};
