...
static const union AnimCmd sAnim_Cocokame_1[] =
{
    ANIMCMD_FRAME(0, 20),
    ANIMCMD_FRAME(1, 30),
    ANIMCMD_FRAME(0, 20),
...
static const union AnimCmd sAnim_Frococo_1[] =
{
    ANIMCMD_FRAME(0, 20),
    ANIMCMD_FRAME(1, 30),
    ANIMCMD_FRAME(0, 20),
...
const union AnimCmd *const *const gMonFrontAnimsPtrTable[NUM_SPECIES + 1] =
{
    ...
    [SPECIES_DRACONARIX_UNLEASHED] = sAnims_DraconarixUnleashed,
    [SPECIES_DRACONARIX_UNLEASHED_ICE] = sAnims_DraconarixUnleashedIce,
    [SPECIES_DRACONARIX_UNLEASHED_FIRE] = sAnims_DraconarixUnleashedFire,
    [SPECIES_DRACONARIX_UNLEASHED_ELECTRIC] = sAnims_DraconarixUnleashedElectric,
