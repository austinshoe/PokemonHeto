...
static const struct FormChange sDraconarixFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX_UNLEASHED, ITEM_ENERGY_CORE},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sDraconarixUnleashedFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX, ITEM_ENERGY_CORE},
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX_UNLEASHED_ICE, ITEM_ICE_CORE},
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX_UNLEASHED_FIRE, ITEM_FIRE_CORE},
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX_UNLEASHED_ELECTRIC, ITEM_ELEC_CORE},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sDraconarixUnleashedIceFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX, ITEM_ENERGY_CORE},
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX_UNLEASHED, ITEM_ICE_CORE},
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX_UNLEASHED_FIRE, ITEM_FIRE_CORE},
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX_UNLEASHED_ELECTRIC, ITEM_ELEC_CORE},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sDraconarixUnleashedFireFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX, ITEM_ENERGY_CORE},
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX_UNLEASHED_ICE, ITEM_ICE_CORE},
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX_UNLEASHED, ITEM_FIRE_CORE},
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX_UNLEASHED_ELECTRIC, ITEM_ELEC_CORE},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sDraconarixUnleashedElectricFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX, ITEM_ENERGY_CORE},
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX_UNLEASHED_ICE, ITEM_ICE_CORE},
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX_UNLEASHED_FIRE, ITEM_FIRE_CORE},
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX_UNLEASHED, ITEM_ELEC_CORE},
    {FORM_CHANGE_TERMINATOR},
};
#endif
