...
static const struct FormChange sDraconarixFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX_UNLEASHED, ITEM_ENERGY_CORE, SPECIES_DRACONARIX},
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX_UNLEASHED, ITEM_ICE_CORE, SPECIES_DRACONARIX_UNLEASHED_ICE},
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX_UNLEASHED, ITEM_FIRE_CORE, SPECIES_DRACONARIX_UNLEASHED_FIRE},
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX_UNLEASHED, ITEM_ELEC_CORE, SPECIES_DRACONARIX_UNLEASHED_ELECTRIC},
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX_UNLEASHED_ICE, ITEM_ICE_CORE, SPECIES_DRACONARIX_UNLEASHED},
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX_UNLEASHED_FIRE, ITEM_FIRE_CORE, SPECIES_DRACONARIX_UNLEASHED},
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX_UNLEASHED_ELECTRIC, ITEM_ELEC_CORE, SPECIES_DRACONARIX_UNLEASHED},
    {FORM_CHANGE_ITEM_USE, SPECIES_DRACONARIX, ITEM_ENERGY_CORE, SPECIES_DRACONARIX_UNLEASHED},
    {FORM_CHANGE_TERMINATOR},
};
#endif
