const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_APPLIN_HETONIAN]       = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_COCOKAME},
                                       {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_FROCOCO}},
    [SPECIES_TOGEPI_HETONIAN]       = {{EVO_LEVEL, 25, SPECIES_TOGETIC_HETONIAN}},
    [SPECIES_TOGETIC_HETONIAN]      = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_TOGEKISS_HETONIAN}},
#endif
};
