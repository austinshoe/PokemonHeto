...
static const u8 sSpeciesToBackAnimSet[NUM_SPECIES] =
{
    ...
    [SPECIES_DRACONARIX]                   = BACK_ANIM_V_SHAKE,
    [SPECIES_DRACONARIX_UNLEASHED]         = BACK_ANIM_V_SHAKE,
    [SPECIES_DRACONARIX_UNLEASHED_ICE]     = BACK_ANIM_V_SHAKE,
    [SPECIES_DRACONARIX_UNLEASHED_FIRE]    = BACK_ANIM_V_SHAKE,
    [SPECIES_DRACONARIX_UNLEASHED_ELECTRIC]= BACK_ANIM_V_SHAKE,
    [SPECIES_TOGEPI_HETONIAN]              = BACK_ANIM_DIP_RIGHT_SIDE,
    [SPECIES_TOGETIC_HETONIAN]             = BACK_ANIM_CONVEX_DOUBLE_ARC,
    [SPECIES_TOGEKISS_HETONIAN]            = BACK_ANIM_CONCAVE_ARC_LARGE,
