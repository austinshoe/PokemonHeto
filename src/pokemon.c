...
//Hisuian Forms
    ...
    [SPECIES_APPLIN_HETONIAN - 1] = NATIONAL_DEX_APPLIN,
    [SPECIES_DRACONARIX_UNLEASHED - 1] = NATIONAL_DEX_DRACONARIX,
    [SPECIES_DRACONARIX_UNLEASHED_ICE - 1] = NATIONAL_DEX_DRACONARIX,
    [SPECIES_DRACONARIX_UNLEASHED_FIRE - 1] = NATIONAL_DEX_DRACONARIX,
    [SPECIES_DRACONARIX_UNLEASHED_ELECTRIC - 1] = NATIONAL_DEX_DRACONARIX,
    [SPECIES_TOGEPI_HETONIAN - 1] = NATIONAL_DEX_TOGEPI,
    [SPECIES_TOGETIC_HETONIAN - 1] = NATIONAL_DEX_TOGETIC,
    [SPECIES_TOGEKISS_HETONIAN - 1] = NATIONAL_DEX_TOGEKISS,
#endif
};
...
const u8 sMonFrontAnimIdsTable[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_DRACONARIX_UNLEASHED - 1]      = ANIM_H_SHAKE,
    [SPECIES_DRACONARIX_UNLEASHED_ICE - 1]  = ANIM_H_SHAKE,
    [SPECIES_DRACONARIX_UNLEASHED_FIRE - 1] = ANIM_H_SHAKE,
    [SPECIES_DRACONARIX_UNLEASHED_ELECTRIC - 1]= ANIM_H_SHAKE,
    [SPECIES_TOGEPI_HETONIAN - 1]           = ANIM_V_JUMPS_BIG,
    [SPECIES_TOGETIC_HETONIAN - 1]          = ANIM_V_SQUISH_AND_BOUNCE,
    [SPECIES_TOGEKISS_HETONIAN - 1]         = ANIM_SWING_CONVEX,
};
