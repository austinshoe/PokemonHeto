...
#define B_WEATHER_ANY                 (B_WEATHER_RAIN | B_WEATHER_SANDSTORM | B_WEATHER_SUN | B_WEATHER_HAIL | B_WEATHER_STRONG_WINDS | B_WEATHER_SNOW | B_WEATHER_ENERGY_STORM)
#define B_WEATHER_PRIMAL_ANY          (B_WEATHER_RAIN_PRIMAL | B_WEATHER_SUN_PRIMAL | B_WEATHER_STRONG_WINDS | B_WEATHER_ENERGY_STORM)
...
#define B_WEATHER_ENERGY_STORM         (1 << 14)
...
#define ENUM_WEATHER_ENERGY_STORM         9
...
#define MOVE_EFFECT_POWER_RELEASE       79
